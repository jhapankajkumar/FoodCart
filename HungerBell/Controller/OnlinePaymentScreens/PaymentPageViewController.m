...
- (void)navigateToPaymentStatusScreen: (NSMutableDictionary *)mutDictTransactionDetails {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if ([self.paymentDelegate respondsToSelector:@selector(setPaymentStatusWithPaymentDictionary:)]) {
            [self.paymentDelegate setPaymentStatusWithPaymentDictionary:mutDictTransactionDetails];
        }
