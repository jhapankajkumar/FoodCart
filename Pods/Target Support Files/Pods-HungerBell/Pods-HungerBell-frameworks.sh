...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-HungerBell/RESideMenu.framework"
  install_framework "Pods-HungerBell/SDWebImage.framework"
  install_framework "Pods-HungerBell/UIActivityIndicator_for_SDWebImage.framework"
  install_framework "Pods-HungerBell/WYPopoverController.framework"
fi
